module Strategies
  def self.all
    [
      ...
      { name: "buffering_local_solar_electric_car",        ajax_prop: "buffering_electric_car", enabled: false},
      { name: "buffering_local_solar_heat_pumps",          ajax_prop: "buffering_heat_pumps", enabled: false},
      { name: "postponing_base_load",                      ajax_prop: "postponing_base_load", enabled: false},
      { name: "saving_aggregated_base_load",               ajax_prop: "saving_base_load", enabled: false},
