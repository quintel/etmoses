class EtEngineConnector
  ...
  ETM_URLS = {
    stats:     '%s/api/v3/scenarios/%d/converters/stats',
    scenario:  '%s/api/v3/scenarios/%d',
    scenarios: '%s/api/v3/scenarios',
    merit:     '%s/api/v3/scenarios/%d/merit',
    inputs:    '%s/api/v3/scenarios/%d/inputs'
  }.freeze
